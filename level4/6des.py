...
def conn_to_server():
    ...
    # print(subprocess.run(["ssh","student@172.27.26.188"],
    #                    shell=False,
    ...
    ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("ciphereum")
    print("hi")
    # ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("mspciphereum")
